...
<body class="bg-dark">
    <div class="bg-dark text-white p-3 m-0">
        <nav class="navbar navbar-expand-sm navbar-dark bg-secondary">
            ...
            <div class="collapse navbar-collapse" id="navegacao2">
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item">
                        <a href="contatos.php" class="nav-link btn btn-light text-dark m-2">Contatos</a>
                    </li>
                    <li class="nav-item">
                ...
                <!-- Formulário -->
                <form class="form-inline m-3" action="../models/usuario_has_grupo/inserir_usuario_has_grupo.php" method="post">
        ...
        <h4 class="h5 bg-white text-dark text-center p-2">Meus Grupos</h4>
        <?php
            ...
            <?php 
                while($row = $meus_grupos -> fetch_assoc()){
                    ...
                    echo "<tr>";
                        ...
                        echo "<td>";
                            echo "<form action='../models/usuario_has_grupo/deletar_usuario_has_grupo.php' method='post'>";
                                echo "<input type='hidden' name='idgrupo' value='".$grupo['idgrupo']."'>";
                                echo "<button class='btn btn-danger btn-sm'>SAIR</button>";
                            echo "</form>";
                        echo "</td>";
                    echo "</tr>";
                }
